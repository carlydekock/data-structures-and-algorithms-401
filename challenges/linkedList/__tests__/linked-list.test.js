...
describe('testing functionality of linked list and node instantiations', () => {
  ...
  it('should add a new node with the given value to the end of the list', () => {
    ...
    // list.head.next = new linkedList.node(1);
    list.append(4);
    // let testAppend = list.append(4);

    // console.log(testAppend.next.value);
  ...
  it('should return null where k is greater than the length of linked list', () => {
    const list = new linkedList.list();
    list.head = new linkedList.node(0);
    list.head.next = new linkedList.node(1);
  ...
  it('should return head value where k and the length of the list are the same', () => {
    const list = new linkedList.list();
    list.head = new linkedList.node(0);
    list.head.next = new linkedList.node(1);
  ...
  it('should return null where k is not a positive integer', () => {
    const list = new linkedList.list();
    list.head = new linkedList.node(0);
    list.head.next = new linkedList.node(1);
    const test = list.kthFromEnd(5);
  ...
  it('should create a linkedin list of size 1', () => {
    const list = new linkedList.list();
    list.head = new linkedList.node(0);
  ...
  it('should return the value of the node kth from the end where k is in the middle of the list', () => {
    const list = new linkedList.list();
    list.head = new linkedList.node(0);
    list.head.next = new linkedList.node(1);
    list.head.next.next = new linkedList.node(2);
